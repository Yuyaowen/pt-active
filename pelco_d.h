...
extern struct pelco_d *set_low_speed(unsigned char cam_addr);
extern struct pelco_d *set_mid_speed(unsigned char cam_addr);
extern struct pelco_d *set_high_speed(unsigned char cam_addr);
